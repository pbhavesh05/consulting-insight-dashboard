...
export function generateInsights(
    ...
    const marginImproved =
      lastMonth.profitMargin > firstMonth.profitMargin;
     // Consulting-style rule: compare cost growth against revenue growth.
  if (costGrowth > revenueGrowth) {
    insights.push({
      title: "Efficiency Opportunity",
      description:
        "Costs are growing faster than revenue. The company should review operating expenses, vendor contracts, and delivery efficiency.",
      status: "warning",
    });
  } else {
    insights.push({
      ...
      description:
        "Revenue is growing faster than costs, suggesting the business is gaining operating leverage.",
      status: "positive",
    });
  }
